...
export default function PricingPage() {
  ...
  const showcaseAmount = billingCycle === "yearly" ? 34990 : 3499;
  const showcaseUpiUri = `upi://pay?pa=${upiId}&pn=KODAND%20Technologies&am=${showcaseAmount}&cu=INR&tn=KODAND_AGENCY_PRO`;
  const showcaseQrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=320x320&data=${encodeURIComponent(showcaseUpiUri)}&color=000000&bgcolor=ffffff&ecc=H&margin=1`;
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 py-12 md:py-16 w-full">
        ...
        <div className="mb-16 p-6 sm:p-8 rounded-2xl border border-emerald-500/40 bg-gradient-to-br from-emerald-950/30 via-zinc-950 to-zinc-950 shadow-2xl">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            {/* Visual QR Code Display - Dynamic Scanner QR Code with Pre-Filled Amount */}
            <div className="flex items-center justify-center p-4 sm:p-5 rounded-2xl bg-white shadow-2xl shrink-0 relative">
              ...
              <img
                ...
                alt={`Scan to Pay ₹${showcaseAmount.toLocaleString("en-IN")} via UPI`}
